...
it('Stars Tokens can be transferred from one address to another.', async()=>{
  ...
  let user2=accounts[2]
  let NewStarId=9
  await instance.createStar('New Star', NewStarId, {from: user1})
